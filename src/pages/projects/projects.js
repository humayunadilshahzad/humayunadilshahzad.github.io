...
const proj =[ 
    ...
    {title:'Meal Sharing',
    pic:mealSharing,
    about:'This App is made for the local comunity who are fond of cooking, sharing and making friend. Idea is they can register online and join and share food with friends',
    skills:['html','css','js','node','figma','Mysql'],
    githubSourceLink:'https://github.com/humayunadilshahzad/meals-sharing',
    webLink:'#'},
    
    {title:'Colorful Circles',
    pic:circlesAppPic,
    about:'This app is made for learning java script only. Learning js Functions and calling them with random values',
    skills:['html','css','js'],
    ...
    {title:'Weather App',
    pic:weatherAppPic,
    about:'This App is made for learning purposes by using weather API, Data recieved from weater API is then randered',
    ...
    {title:'Giffy App',
    pic:giffyAppPic,
    about:'This App is made for learning purposes. free API is been used which sends back asked images',
    skills:['html','css','js','API'],
